...
public class BluetoothConnectionService {
     ...
     * @param server 
     */
    public BluetoothConnectionService(Context context, Handler handler, String uuid, String sdp_name) {
    	this.uuid = uuid;
    	this.sdp_name = sdp_name;
        if (D) Log.d(TAG, "SDP: " + sdp_name);
    ...
    private synchronized void setState(int state) {
        ...
        mHandler.obtainMessage(BluetoothConnectionDialog.MESSAGE_STATE_CHANGE, state, -1).sendToTarget();
    }
    ...
    public synchronized void connected(BluetoothSocket socket, BluetoothDevice device) {
        ...
        Message msg = mHandler.obtainMessage(BluetoothConnectionDialog.MESSAGE_DEVICE_NAME);
        Bundle bundle = new Bundle();
        bundle.putString(BluetoothConnectionDialog.DEVICE_NAME, device.getName());
        msg.setData(bundle);
    ...
    private void connectionFailed() {
        ...
        Message msg = mHandler.obtainMessage(BluetoothConnectionDialog.MESSAGE_TOAST);
        Bundle bundle = new Bundle();
        bundle.putString(BluetoothConnectionDialog.TOAST, "Unable to connect device");
        msg.setData(bundle);
        mHandler.sendMessage(msg);
    }
    ...
    private void connectionLost() {
        ...
        Message msg = mHandler.obtainMessage(BluetoothConnectionDialog.MESSAGE_TOAST);
        Bundle bundle = new Bundle();
        bundle.putString(BluetoothConnectionDialog.TOAST, "Device connection was lost");
        msg.setData(bundle);
        mHandler.sendMessage(msg);
    }
    ...
    private class AcceptThread extends Thread {
        ...
        public AcceptThread() {
            ...
            try {
                tmp = mAdapter.listenUsingRfcommWithServiceRecord(sdp_name, UUID.fromString(uuid));
            } catch (IOException e) {
...
E/BluetoothConnectionService( 1805): 	at dk.hotmovinglobster.dustytuba.sampleapp.BluetoothConnectionService$ConnectedThread.run(BluetoothConnectionService.java:408)
        ...
        public void write(byte[] buffer) {
            try {
                ...
                mHandler.obtainMessage(BluetoothConnectionDialog.MESSAGE_WRITE, -1, -1, buffer)
                        .sendToTarget();
            } catch (IOException e) {
