...
public class BluetoothConnector extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        // TODO: CHANGE TO BT_API_CONSTANTS
        ...
        //setContentView(BtAPI.res( this, "layout", "bt_conn_dialog" )); // FIXME: Will fail, not created
    ...
    private void setupUI() {
        ...
        mConversationArrayAdapter = new ArrayAdapter<String>(this, BtAPI.res( this, "layout", "bt_conn_dialog_message" ));  // FIXME: Will fail, not created
        mConversationView = (ListView) findViewById(BtAPI.res( this, "id", "in" ));  // FIXME: Will fail, not created
        ...
        mCancelButton = (Button) findViewById(BtAPI.res( this, "id", "btCon_cancel" ));  // FIXME: Will fail, not created
        ...
        mSendButton = (Button) findViewById(BtAPI.res( this, "id", "btCon_inject" ));  // FIXME: Will fail, not created
    ...
    private void sendMessage(byte[] message) {
        ...
        if (mConnService.getState() != BluetoothConnectionService.STATE_CONNECTED) {
            ...
            mConnService.stop(); // FIXME: Not retrying, but just abandoning connection
        ...
        public void handleMessage(Message msg) {
            ...
            case MESSAGE_READ:
                ...
                if (readMessage != null && !"".equals(readMessage)){
	                ...
	                BluetoothConnector.this.sendMessage(("This is a reply to: " + readMessage).getBytes());
                }
