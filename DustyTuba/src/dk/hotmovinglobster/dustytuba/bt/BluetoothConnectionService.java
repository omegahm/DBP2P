...
public class BluetoothConnectionService {
    ...
    private void connectionFailed() {
        ...
        Bundle bundle = new Bundle();
        bundle.putString(BluetoothConnector.TOAST, "Unable to connect device");
        msg.setData(bundle);
        mHandler.sendMessage(msg);
    }
...
E/BluetoothConnectionService( 1805): 	at dk.hotmovinglobster.dustytuba.sampleapp.BluetoothConnectionService$ConnectedThread.run(BluetoothConnectionService.java:408)
                    ...
                    mHandler.obtainMessage(BluetoothConnector.MESSAGE_READ, bytes, -1, buffer)
                            .sendToTarget();
                } catch (IOException e) {
        ...
        public void write(byte[] buffer) {
            try {
                ...
                mHandler.obtainMessage(BluetoothConnector.MESSAGE_WRITE, -1, -1, buffer)
                        .sendToTarget();
            } catch (IOException e) {
